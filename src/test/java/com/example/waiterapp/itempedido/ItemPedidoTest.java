...
class ItemPedidoTest {
    ...
    void setUp() {
        ...
        item   = new Item(1L, "Pizza Napolitana", "Pizza com tomate e manjericão", FIXED_DATE, 40.0);
    }

    // ======================= getSubTotal() =======================

    @ParameterizedTest(name = "quantidade={0} => subtotal={1}")
    @CsvSource({
        "3, 120.0",
        "1,  40.0",
        "0,   0.0"
    ...
    void getSubTotal_deveCalcularSubtotalCorretamente(int quantidade, double esperado) {
        ItemPedido itemPedido = new ItemPedido(pedido, item, quantidade);
        assertEquals(esperado, itemPedido.getSubTotal(), 0.001);
    }
    ...
    void getSubTotal_precoDecimal_deveCalcularCorretamente() {
        ...
        Item itemDecimal = new Item(2L, "Suco Natural", "Fresco", FIXED_DATE, 7.50);
    ...
    void getSubTotal_precoDoItemZero_deveRetornarZero() {
        // Arrange
        Item itemGratuito = new Item(3L, "Água", "Cortesia", FIXED_DATE, 0.0);
    ...
    void getSubTotal_grandeQuantidade_deveCalcularCorretamente() {
        ...
        Item itemCaro = new Item(4L, "Item Especial", "Desc", FIXED_DATE, 10.0);
    ...
    void setItem_deveAlterarItemAssociado() {
        // Arrange
        ItemPedido itemPedido = new ItemPedido(pedido, item, 1);
        Item novoItem = new Item(2L, "Salada", "Verde", FIXED_DATE, 12.0);
    ...
    void setPedido_deveAlterarPedidoAssociado() {
        // Arrange
        ItemPedido itemPedido = new ItemPedido(pedido, item, 1);
        Pedido novoPedido = new Pedido(2L, FIXED_DATE, Estado.PENDENTE, 0.0, null, null, null);
