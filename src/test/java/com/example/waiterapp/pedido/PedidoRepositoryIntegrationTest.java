...
class PedidoRepositoryIntegrationTest {
    ...
    void save_pedidoValido_devePersistirERecuperarPorId() {
        ...
        Cliente cliente = clienteRepository.save(
                new Cliente(null, "Maria Souza", "maria@test.com", "11122233344", FIXED_DATE));

        Pedido pedido = new Pedido(null, FIXED_DATE, Estado.EM_PREPARACAO, 50.0, null, null, null);
    ...
    void findallByIdCliente_clienteComPedidos_deveRetornarSeusPedidos() {
        // Arrange
        Cliente cliente = clienteRepository.save(
                new Cliente(null, "João Pereira", "joao.p@test.com", "55566677788", FIXED_DATE));

        Pedido pedido1 = new Pedido(null, FIXED_DATE.minusDays(1), Estado.FECHADO, 30.0, null, null, null);
        pedido1.setCliente(cliente);

        Pedido pedido2 = new Pedido(null, FIXED_DATE, Estado.EM_PREPARACAO, 20.0, null, null, null);
    ...
    void findallByIdCliente_clienteSemPedidos_deveRetornarListaVazia() {
        // Arrange
        Cliente cliente = clienteRepository.save(
                new Cliente(null, "Ana Lima", "ana.lima@test.com", "99988877766", FIXED_DATE));
